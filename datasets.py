...
def main():
    main_df = pd.read_csv(io.StringIO(zipfile.ZipFile("dataset/RLCS 2021-22 Dataset.zip").read("main.csv").decode("utf-8")))
    return main_df

def players_db():
    players_db_df = pd.read_csv(io.StringIO(zipfile.ZipFile("dataset/RLCS 2021-22 Dataset.zip").read("players_db.csv").decode("utf-8")))
    return players_db_df

def matches_by_teams():
    matches_by_teams_df = pd.read_csv(io.StringIO(zipfile.ZipFile("dataset/RLCS 2021-22 Dataset.zip").read("matches_by_teams.csv").decode("utf-8")))
...
def games_by_teams_df():
    games_by_teams_df = pd.read_csv(io.StringIO(zipfile.ZipFile("dataset/RLCS 2021-22 Dataset.zip").read("games_by_teams.csv").decode("utf-8")))
